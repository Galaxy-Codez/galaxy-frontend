...
export const metadata: Metadata = {
  title: "Contact",
  description: `Contact GalaxyCodez effortlessly for software inquiries, support, or collaboration opportunities. Our dedicated team is ready to assist you in navigating the digital realm with innovative technology and expert services. Trust GalaxyCodez for precision and excellence.`,
  keywords:
